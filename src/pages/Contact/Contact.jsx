...
const Contact = () => {
    ...
    return (
        <div>
            ...
            <div className={`d-flex align-items-center justify-content-center ${styles.contactBanner}`}>
                                ...
                                <form className="mx-auto  d-flex justify-content-center align-items-center flex-column w-100" onSubmit={handleSubmit(onSubmit)}>
                                    <Row className="mx-auto w-100 ">
                                        <Col className="p-0 me-3">
                                            <input className={`w-100 mx-auto my-2 p-3 border border-2 rounded-3 ${styles.inputBg}`} type="text" placeholder="Full name" {...register("visitorName", { required: true, maxLength: 80 })} />

                                        </Col>
                                        <Col className="p-0">
                                            <input className={`w-100 mx-auto my-2 p-3 border border-2 rounded-3 ${styles.inputBg}`} type="text" placeholder="Email" {...register("visitorEmail", { required: true, pattern: /^\S+@\S+$/i })} />
                                        </Col>
                                    </Row>
                                    <textarea className={`w-100 mx-auto my-2 p-3 border border-2 rounded-3 ${styles.inputBg}`} placeholder="Write commnet"{...register("visitorComment", { required: true })} />

                                    <Button className={` border-0 w-50 fs-4 ${styles.myButton}`} variant="dark" type="submit">Submit</Button>
                                </form>
                            </div>
                        </Col>
                    </Row>
                    ...
                    <div className="py-5 px-auto mx-auto">
                        <Row xs={1} md={2} lg={3}>
                            <Col className="mx-auto my-3">
                                <div className={`d-flex align-items-center justify-content-center flex-column mx-auto p-3 text-white rounded-3 ${styles.contactInfo}`}>
