    ...
    return (
        <div>
            <Container>
                ...
                <div className={`mx-auto rounded-3 p-3 shadow-sm ${styles.addReviewSection}`}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Button className={`border-0 fw-bold px-3 w-50 mx-auto  d-flex justify-content-center align-items-center ${styles.myButton}`} variant="dark" type="submit">
                            Submit
                        </Button>
                    </form>
