...
const OrderModal = ({ showModal, handleModalClose, product, orderNotify }) => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("https://drive-and-drive-server.vercel.app/orders", data)
      .then((res) => {
  ...
  return (
    <div>
      <Modal show={showModal} onHide={handleModalClose}>
        ...
        <Modal.Body>
          <div
            className={`mx-auto p-3 rounded-3 shadow-sm ${styles.bookingForm}`}
          >
            <form
            ...
            >
              ...
              <Button
                className={`border-0 fw-bold px-3 w-100 mt-3 ${styles.myButton}`}
                variant="dark"
                type="submit"
              >
                Confirm
